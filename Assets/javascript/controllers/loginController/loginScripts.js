let runScripts = async () => {
    ...
    let loginPageUI = await scriptCreate("Login page UI script", "./Assets/javascript/views/loginView/loginPageDisplay.js", 40);
    let errorMessageCont = await scriptCreate("Error Message Container and Array Script", "./Assets/javascript/views/loginView/errorContainers.js", 50);
