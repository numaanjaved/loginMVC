let runScripts = async () => {
    ...
    let route = await scriptCreate("route script", "./Assets/javascript/controllers/loginController/route.js", 15);
    ...
    let scriptsArray = [validationLogin, route, UserClass, AdminClass, loginPageUI, errorMessageCont, errorMessage, loginValidationHandler]
    return scriptsArray;
};
